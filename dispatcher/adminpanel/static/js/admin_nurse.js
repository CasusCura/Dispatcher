...
function updatenurseDev(){
	var devType = document.getElementById("devicetype").value;
	var status = document.getElementById("status").value;
	var location = document.getElementById("location").value;
	var serial = document.getElementById("serial").value;
	var id = document.getElementById("id").value;
	var deviceDetails = '{"device":{"used_by":"nurse","serial":"'+serial+'","device_type":"'+ devType +'", "status":"'+ status +'","location":"'+ location +'","device_id":"'+id+'"}}';
...
function updateDeviceType(){
	...
	var json = '{"device_type":{'+deviceTypeId+'"used_by":"nurse","product_name":"'+devType+'","product_description":"'+desc+'"}}';
